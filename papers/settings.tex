...
\definecolor{JuliaBlue}{RGB}{83,124,178}
\definecolor{JuliaBeige}{RGB}{216,166,49}
...
% You may want to use `clevceref` instead of using \autoref in the hyperref package, which has slightly more possibilities.\PassOptionsToPackage{pdfpagelabels}{hyperref}
