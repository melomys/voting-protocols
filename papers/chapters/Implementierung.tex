...
Für jeden Post $P$ wird mit der Bewertungsmetrik $s_P = B(P,i_M)$ berechnet. Anschließend werden ${P_N}_{iter}$ neue Posts dem Modell hinzugefügt. definiert. Falls es erwünscht ist werden im nächsten Schritt die Postscores mit zufälligem Lärm verunreinigt. Nun können die Posts nach ihren Scores sortiert werden und die Modelliteration ist abgeschlossen.
